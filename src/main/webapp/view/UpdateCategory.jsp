...
<h1>修改类别</h1>
	...
	<table>
		<tr>
			...
			<td>
				<select name="parent_id">
					<option value="${category.parent_id}">${parent_id}</option>
		...
		<%--<tr>
			<td>创建时间</td>
			<td><input type="text" name="create_time" value="${category.create_time }"/></td>
		</tr>
		<tr>
			<td>更新时间</td>
			<td><input type="text" name="update_time" value="${category.update_time }"/></td>
		</tr>--%>
