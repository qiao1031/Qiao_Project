...
public class UserOrder {
    ...
    public UserOrder(int id, long order_no, int user_id, int shipping_id, double payment, int payment_type, int postage, int status, long payment_time, long send_time, long end_time, long close_time, long create_time, long update_time, List<UserOrderItem> userOrderItems) {
        this.id = id;
